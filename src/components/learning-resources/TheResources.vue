<template>
    <base-card>
        <base-button @click="setSelectedTab('stored-resources')" :mode="soredResBtnMode">Stored Resorces</base-button>
...
export default {
    ...
    methods: {
        ...
        deleteResource(index) {
            const idx = this.storedResources.findIndex(item => item.id === index);
